...
public class MilkCoffeeDrinks extends javax.swing.JInternalFrame {
     ...
     */
    public MilkCoffeeDrinks() {
        initComponents();
        items=new ArrayList<kaffeine.coffee.shop.Item>();
        items.add(new kaffeine.coffee.shop.Item(1,"Cappucino Small", 10, 450.00f, 2));
        items.add(new kaffeine.coffee.shop.Item(2,"Cappucino Medium", 8,  270.00f, 5));
        items.add(new kaffeine.coffee.shop.Item(3,"Cappucino Large", 10, 600.00f, 2));
        items.add(new kaffeine.coffee.shop.Item(4,"Latte Milk Small", 10, 300.00f, 2));
        items.add(new kaffeine.coffee.shop.Item(5,"Latte Milk Medium", 8,  370.00f, 5));
        items.add(new kaffeine.coffee.shop.Item(6,"Latte Milk Large", 8,  470.00f, 5));
        items.add(new kaffeine.coffee.shop.Item(7,"Cafe Mocha Small",12, 295.00f, 3));
        items.add(new kaffeine.coffee.shop.Item(8,"Cafe Mocha Medium",12, 395.00f, 3));
        items.add(new kaffeine.coffee.shop.Item(9,"Cafe Mocha Large",12, 495.00f, 3));
        items.add(new kaffeine.coffee.shop.Item(10,"Eiskeffee Small",   30, 200.00f, 8));
        items.add(new kaffeine.coffee.shop.Item(11,"Eiskeffee Medium",   30, 300.00f, 8));
        items.add(new kaffeine.coffee.shop.Item(12,"Eiskeffee Large",   30, 400.00f, 8));
        items.add(new kaffeine.coffee.shop.Item(13,"Galao Small", 2, 250.00f, 4));
        items.add(new kaffeine.coffee.shop.Item(14,"Galao Medium", 2, 350.00f, 4));
        items.add(new kaffeine.coffee.shop.Item(15,"Galao Large", 2, 450.00f, 4));
        items.add(new kaffeine.coffee.shop.Item(16,"Caffe Marocchino Small", 2, 275.00f, 4));
        items.add(new kaffeine.coffee.shop.Item(17,"Caffe Marocchino Medium", 2, 475.00f, 4));
        items.add(new kaffeine.coffee.shop.Item(18,"Caffe Marocchino Large", 2, 575.00f, 4));
        ...
        df.addElement(items.get(15));
        df.addElement(items.get(16));
        df.addElement(items.get(17));
        ...
        dm.addElement(items.get(15));
        dm.addElement(items.get(16));
        dm.addElement(items.get(17)); 
    }
