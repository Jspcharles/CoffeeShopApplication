...
public class NonMilkCoffeeDrinks extends javax.swing.JInternalFrame {
     ...
     */
    public NonMilkCoffeeDrinks() {
        initComponents();
        items=new ArrayList<kaffeine.coffee.shop.Item>();
        items.add(new kaffeine.coffee.shop.Item(1,"Short Black Small", 10, 215.00f, 2));
        items.add(new kaffeine.coffee.shop.Item(2,"Short Black Medium", 10, 315.00f, 2));
        items.add(new kaffeine.coffee.shop.Item(3,"Short Black Large", 10, 415.00f, 2));
        items.add(new kaffeine.coffee.shop.Item(4,"Long Black Small", 8,  150.00f, 5));
        items.add(new kaffeine.coffee.shop.Item(5,"Long Black Medium", 8,  200.00f, 5));
        items.add(new kaffeine.coffee.shop.Item(6,"Long Black Large", 8,  300.00f, 5));
        items.add(new kaffeine.coffee.shop.Item(7,"Ristretto Small",12, 175.00f, 3));
        items.add(new kaffeine.coffee.shop.Item(8,"Ristretto Medium",12, 275.00f, 3));
        items.add(new kaffeine.coffee.shop.Item(9,"Ristretto Large",12, 375.00f, 3));
