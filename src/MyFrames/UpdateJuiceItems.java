 ...
 */
public class UpdateJuiceItems extends javax.swing.JInternalFrame {
    ...
    try {
            ...
            String Query = "UPDATE JUICETABLE SET ITEMNAME = '"+NameText.getText()+"', ITEMPRICE = '"+PriceText.getText()+"' WHERE ITEMNAME = '"+List1.getSelectedValue()+"'";
            stmt.execute(Query);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            Connection con = DriverManager.getConnection(url,username,password);
            Statement stmt = con.createStatement();
               String Query="DELETE FROM JUICETABLE WHERE ITEMNAME='"+List1.getSelectedValue()+"'";
              stmt.execute(Query);
       JOptionPane.showMessageDialog(null,"Item info Updated Successfully");
                 fillList1();
